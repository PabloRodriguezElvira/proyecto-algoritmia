...
VI seleccionarSubconjunto(const Grafo& G, VB& activados, double prob) {
    int n = G.size();
...
int main () {
    ...
    int t = 0;
    VI C = seleccionarSubconjunto(G, activados, prob);
